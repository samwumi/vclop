          ...
          create: source.sections.map((section) => ({
            ...
            fields: {
              create: section.fields.map((field) => ({
                ...
                defaultValue: (field.defaultValue ?? undefined) as Prisma.InputJsonValue | undefined,
                ...
                visibilityRule: (field.visibilityRule ?? undefined) as Prisma.InputJsonValue | undefined,
  ...
  async addField(templateId: string, sectionId: string, dto: CreateFormFieldDto, actorId: string): Promise<unknown> {
    ...
    const field = await this.prisma.formField.create({
      data: {
        ...
        visibilityRule: dto.visibilityRule as Prisma.InputJsonValue | undefined,
        sortOrder,
      },
    });
  ...
  async updateField(templateId: string, fieldId: string, dto: UpdateFormFieldDto, actorId: string): Promise<unknown> {
    ...
    await this.prisma.formField.update({
      ...
      data: {
        ...
        ...(dto.defaultValue !== undefined && { defaultValue: dto.defaultValue as Prisma.InputJsonValue }),
        ...
        ...(dto.visibilityRule !== undefined && { visibilityRule: dto.visibilityRule as Prisma.InputJsonValue }),
        ...(dto.sortOrder !== undefined && { sortOrder: dto.sortOrder }),
        ...(dto.isActive !== undefined && { isActive: dto.isActive }),
      },
    });
