...
import { CheckCircle2, XCircle, Send, Banknote, UserPlus, Landmark, Wallet, Zap, Copy, Receipt } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      <div className="card">
        ...
        <div className="border-t border-gray-100 px-6 py-3 flex flex-wrap gap-2">
          ...
          {application.status === 'APPROVED' && hasPermission('DISBURSE_LOAN') && (
