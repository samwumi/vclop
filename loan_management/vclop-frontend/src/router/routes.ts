...
import {
  LayoutDashboard, Users, FileText, ShieldCheck, BookOpen,
  TrendingDown, BarChart2, Settings, GitBranch, Building2,
  Layers, Key, ScrollText, Package, GitMerge,
} from 'lucide-react';
...
export const APP_ROUTES: RouteConfig[] = [
  ...
  // ── Admin Config ───────────────────────────────────────────────────────────
  { path: '/admin/loan-products', label: 'Loan Products', icon: Package,   permission: 'loan_products:read', group: 'Admin Config' },
  { path: '/admin/workflows',     label: 'Workflows',     icon: GitMerge,  permission: 'dashboard:read',         group: 'Admin Config' },
  { path: '/admin/forms',         label: 'Form Engine',  icon: FileText, permission: 'forms:read',      group: 'Admin Config' },
];
